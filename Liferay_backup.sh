...
STORE_FOLDER="/backup/Captive/application/"
SOURCEFOLDER="/opt/liferay-portal-7.1.3-ga4/"
...
function do_backups() {
  # Get db name or "all"
        ...
        DESTINATION=$BACKUP_PATH/weekly-$TODAY.tar.gz #create a backup file using the current date in it's name
...
find   /backup/Captive/application  -iname *.gz -mtime +15 -delete 
